setTimeout(() => {
  ...
  if (errores.length > 0) {
    ...
    if (nombre != '' && tipo_prod != '') {
      ...
      getToken().then(function (dataAuth) {
        ...
        $.ajax({
          async: false,
          url: `${backandGlobal.api2}/FrutaNet_Lappiz.api/api/lappiz/FrutaNet_Lappiz_Productos`,
          type: 'POST',
          ...
          success: function (result) {
            ...
            //let idProv = ajaxQuery(`select Id from FrutaNet_Lappiz_Proveedor where Nombre = '${nombre}' AND Tamano = '${tama}'`, token)
            ...
            var url = `${backandGlobal.api2}/FrutaNet_Lappiz.api/api/lappiz/FrutaNet_Lappiz_DetalleProducto`;
            $.ajax({
              async: false,
              url: url,
              type: 'POST',
  ...
  function ajaxQuery(query, token) {
    ...
    $.ajax({
      async: false,
      url: `${backandGlobal.api2}/FrutaNet_Lappiz.api/api/lappiz/sp/query`,
      type: 'POST',
